...
\newfontfamily\subsectionfont[Scale=1.1]{Liberation Sans}
...
\fancyfoot[LE]{
  \ifx\ChaptersEndQ\undefined {
    \ifnum \thechapter>0 {
      \footfont\textbf{\thepage}~|~Глава \thechapter. \nouppercase{\leftmark{}}
    } \else {
      \footfont\textbf{\thepage}~|~\ChapterTitle
    } \fi
  } \else {
    \footfont\textbf{\thepage}~|~\ChapterTitle
  } \fi
