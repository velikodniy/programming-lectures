...
\newcommand{\Title}{Системы программирования}
\newcommand{\SubTitle}{Часть I}
\newcommand{\PubType}{Курс лекций}
\newcommand{\Year}{2012}

\newcommand{\UDC}{371.385(072)}%{\textbf{???}} % УДК
\newcommand{\BBK}{Ч481.254р30+Ч481.286р30}%{\textbf{???}} % ББК
\newcommand{\AS}{П44}%{\textbf{???}}  % Авторский знак
